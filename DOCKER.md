...
1. **Volumes nommés** pour les données importantes
1. **Restart policy** : `unless-stopped` ou `always`
1. **Limites de ressources** pour éviter la surconsommation
1. **Healthchecks** pour monitoring automatique
1. **Logs rotatifs** pour éviter saturation disque
1. **Backups réguliers** de la base de données
